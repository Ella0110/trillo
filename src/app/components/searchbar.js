    ...
    <div className="flex item-center justify-center bg-white border shadow-lg text-xs rounded-full w-full max-w-2xl mx-auto">
      <div className="flex justify-between text-gray-700 item-center  w-full">
        <div className="flex flex-col justify-center p-2 pl-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label htmlFor="where" type="text" className="block text-black ">Where</label>
          <input
            id="where"
            type="text"
        ...
        <div className="flex flex-col justify-center p-2 pl-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label htmlFor="check-in" type="text" className="block text-black">Check In</label>
          <DateInput id="check-in" value = {checkIn} minDate={today} onChange={setCheckIn} />
        </div>

        <div className="flex flex-col justify-center p-2 pl-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label htmlFor="check-out" className="block text-black">Check Out</label>
          <DateInput id="check-out" value = {checkOut} minDate={checkIn || today} onChange={setCheckOut} />
        </div>

        <div className="flex flex-col justify-center p-2 px-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label htmlFor="guests" className="block text-black">Guests</label>
          <input
            id="guests"
            type="number"
            placeholder="1 Adult"
