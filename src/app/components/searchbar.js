    ...
    <div className="flex item-center justify-center bg-white border shadow-lg text-xs rounded-full w-full max-w-2xl mx-auto">
      <div className="flex justify-between item-center w-full">
        ...
        <div className="p-2 pl-8 rounded-full cursor-pointer hover:bg-gray-100">
          ...
          <input type="date" placeholder="Add Dates" className="w-full bg-transparent text-gray-700 focus:outline-none" value={checkIn} onChange={(e) => setCheckIn(e.target.value)}/>
        </div>  

        <div className="p-2 pl-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label className="block text-black">Chech Out</label>
          <input type="date" className="w-full bg-transparent text-gray-700 focus:outline-none" value={checkOut} onChange={(e) => setCheckOut(e.target.value)}/>
        </div>
        
        <div className="p-2 px-8 rounded-full cursor-pointer hover:bg-gray-100">
          <label className="block text-black">Guests</label>
          <input type="number" placeholder="1 Adult" className="w-full bg-transparent  hover:text-gray-700 max-w-12 focus:outline-none" value={guests} onChange={(e) => setGuests(e.target.value)} />
        </div>
