const SideItem = ({iconName, itemName, className}) => {
  return (
    <li className={`relative py-2 lg:mb-1 w-full hover:bg-[rgb(235,47,100)] active:bg-[rgb(255,51,102)] transition-all duration-75 ${className}`}>
      <a
        href=""
